...
logic unsigned [0:0] emit_kick;
logic unsigned [0:0] gen160_cyclix_genvar;
logic unsigned [0:0] gen161_cyclix_genvar;
logic unsigned [0:0] gen162_cyclix_genvar;
logic unsigned [32:0] gen163_cyclix_genvar;
logic unsigned [0:0] gen164_cyclix_genvar;
logic unsigned [0:0] gen165_cyclix_genvar;
logic unsigned [0:0] gen166_cyclix_genvar;
logic unsigned [0:0] gen167_cyclix_genvar;
logic unsigned [0:0] gen168_cyclix_genvar;
logic unsigned [0:0] gen169_cyclix_genvar;
logic unsigned [0:0] gen170_cyclix_genvar;
logic unsigned [32:0] gen171_cyclix_genvar;
logic unsigned [0:0] gen172_cyclix_genvar;
logic unsigned [1:0] gen173_cyclix_genvar;
logic unsigned [0:0] gen174_cyclix_genvar;
logic unsigned [0:0] gen175_cyclix_genvar;
logic unsigned [32:0] gen176_cyclix_genvar;
...
logic unsigned [32:0] gen181_cyclix_genvar;
...
logic unsigned [32:0] gen195_cyclix_genvar;
...
logic unsigned [1:0] gen213_cyclix_genvar;
...
logic unsigned [32:0] gen220_cyclix_genvar;
...
logic unsigned [32:0] gen230_cyclix_genvar;
logic unsigned [0:0] gen231_cyclix_genvar;
logic unsigned [0:0] gen232_cyclix_genvar;
logic unsigned [32:0] gen233_cyclix_genvar;
logic unsigned [32:0] gen234_cyclix_genvar;
...
logic unsigned [18:0] gen249_cyclix_genvar;
logic unsigned [19:0] gen250_cyclix_genvar;
...
logic unsigned [16:0] gen270_cyclix_genvar;
...
logic unsigned [16:0] gen281_cyclix_genvar;
logic unsigned [15:0] gen282_cyclix_genvar;
...
logic unsigned [0:0] gensticky_neur_kick;
always_ff @(posedge clk_i)
	if (rst_i)
		begin
		gensticky_neur_kick <= 32'd0;
		end
	else
		begin
		gensticky_neur_kick <= neur_kick;
		end
...
logic unsigned [0:0] gensticky_emit_kick;
always_ff @(posedge clk_i)
	if (rst_i)
		begin
		gensticky_emit_kick <= 32'd0;
		end
	else
		begin
		gensticky_emit_kick <= emit_kick;
		end
...
always_comb
	...
	tick = 32'd0;
	tg0_counter = 32'd0;
	gen163_cyclix_genvar = 32'd0;
	tg0_next = 32'd0;
	gen166_cyclix_genvar = 32'd0;
	act_spike_in = 32'd0;
	...
	gen174_cyclix_genvar = 32'd0;
	gen175_cyclix_genvar = 32'd0;
	gen4_rtl_var = 32'd0;
	...
	// Payload logic
	tick = 32'd0;
	gen160_cyclix_genvar = (tg0_counter == tg0_last);
	gen161_cyclix_genvar = gen160_cyclix_genvar;
	gen0_rtl_var = gen161_cyclix_genvar;
	if (gen0_rtl_var)
		begin
		tick = 32'd1;
		tg0_counter = 32'd0;
		end
	gen162_cyclix_genvar = 1'd0;
	gen162_cyclix_genvar = (gen162_cyclix_genvar || gen161_cyclix_genvar);
	gen162_cyclix_genvar = !gen162_cyclix_genvar;
	gen1_rtl_var = gen162_cyclix_genvar;
	if (gen1_rtl_var)
		begin
		gen163_cyclix_genvar = (tg0_counter + 32'd1);
		tg0_next = gen163_cyclix_genvar;
		tg0_counter = tg0_next;
		end
	full_spike_in = full_r_spike_in;
	gen164_cyclix_genvar = (tick == 32'd1);
	gen165_cyclix_genvar = gen164_cyclix_genvar;
	gen2_rtl_var = gen165_cyclix_genvar;
	if (gen2_rtl_var)
		begin
		gen166_cyclix_genvar = ~act_spike_in;
		act_spike_in = gen166_cyclix_genvar;
		end
	gen167_cyclix_genvar = ~full_r_spike_in;
	gen168_cyclix_genvar = (wr_spike_in && gen167_cyclix_genvar);
	wr_en_spike_in = gen168_cyclix_genvar;
	gen169_cyclix_genvar = (wr_en_spike_in == 32'd1);
	gen170_cyclix_genvar = gen169_cyclix_genvar;
	gen3_rtl_var = gen170_cyclix_genvar;
	if (gen3_rtl_var)
		begin
		mem_spike_in[wptr_spike_in] = wr_data_spike_in;
		gen171_cyclix_genvar = (credit_spike_in[act_spike_in] + 32'd1);
		credit_spike_in[act_spike_in] = gen171_cyclix_genvar;
		end
	wr_credit_spike_in = credit_spike_in[act_spike_in];
	gen172_cyclix_genvar = ~act_spike_in;
	rd_credit_spike_in = credit_spike_in[gen172_cyclix_genvar];
	...
	gen173_cyclix_genvar = {wr_spike_in, rd_spike_in};
	case (gen173_cyclix_genvar)
		32'd1:
			begin
			gen174_cyclix_genvar = ~empty_spike_in;
			gen175_cyclix_genvar = gen174_cyclix_genvar;
			gen4_rtl_var = gen175_cyclix_genvar;
			if (gen4_rtl_var)
				begin
				gen176_cyclix_genvar = (rptr_spike_in + 32'd1);
				rptr_n_spike_in = gen176_cyclix_genvar;
				full_n_spike_in = 32'd0;
				gen177_cyclix_genvar = (rd_credit_spike_in > 32'd0);
				gen178_cyclix_genvar = gen177_cyclix_genvar;
				gen5_rtl_var = gen178_cyclix_genvar;
				if (gen5_rtl_var)
					begin
					gen179_cyclix_genvar = ~act_spike_in;
					gen180_cyclix_genvar = ~act_spike_in;
					gen181_cyclix_genvar = (credit_spike_in[gen180_cyclix_genvar] - 32'd1);
					credit_spike_in[gen179_cyclix_genvar] = gen181_cyclix_genvar;
					end
				gen182_cyclix_genvar = 1'd0;
				gen182_cyclix_genvar = (gen182_cyclix_genvar || gen178_cyclix_genvar);
				gen182_cyclix_genvar = !gen182_cyclix_genvar;
				gen6_rtl_var = gen182_cyclix_genvar;
				if (gen6_rtl_var)
					begin
					gen183_cyclix_genvar = ~act_spike_in;
					credit_spike_in[gen183_cyclix_genvar] = 32'd0;
					end
				gen184_cyclix_genvar = (rptr_spike_in + 32'd1);
				gen185_cyclix_genvar = (gen184_cyclix_genvar == wptr_spike_in);
				gen186_cyclix_genvar = gen185_cyclix_genvar;
				gen7_rtl_var = gen186_cyclix_genvar;
				if (gen7_rtl_var)
					begin
					empty_n_spike_in = 32'd1;
					end
				end
			gen187_cyclix_genvar = 1'd0;
			gen187_cyclix_genvar = (gen187_cyclix_genvar || gen175_cyclix_genvar);
			gen187_cyclix_genvar = !gen187_cyclix_genvar;
			gen8_rtl_var = gen187_cyclix_genvar;
			if (gen8_rtl_var)
				begin
				gen188_cyclix_genvar = ~act_spike_in;
				credit_spike_in[gen188_cyclix_genvar] = 32'd0;
				end
			end
		32'd2:
			begin
			gen189_cyclix_genvar = ~full_r_spike_in;
			gen190_cyclix_genvar = gen189_cyclix_genvar;
			gen9_rtl_var = gen190_cyclix_genvar;
			if (gen9_rtl_var)
				begin
				gen191_cyclix_genvar = (wptr_spike_in + 32'd1);
				wptr_n_spike_in = gen191_cyclix_genvar;
				empty_n_spike_in = 32'd0;
				gen192_cyclix_genvar = (wptr_spike_in + 32'd1);
				gen193_cyclix_genvar = (gen192_cyclix_genvar == rptr_spike_in);
				gen194_cyclix_genvar = gen193_cyclix_genvar;
				gen10_rtl_var = gen194_cyclix_genvar;
				if (gen10_rtl_var)
					begin
		...
		32'd3:
			begin
			gen195_cyclix_genvar = (wptr_spike_in + 32'd1);
			wptr_n_spike_in = gen195_cyclix_genvar;
			...
			gen11_rtl_var = gen198_cyclix_genvar;
			if (gen11_rtl_var)
				begin
			...
			gen12_rtl_var = gen202_cyclix_genvar;
			if (gen12_rtl_var)
				begin
	...
	gen204_cyclix_genvar = (tick == 32'd1);
	gen205_cyclix_genvar = gen204_cyclix_genvar;
	gen13_rtl_var = gen205_cyclix_genvar;
	if (gen13_rtl_var)
		begin
		gen206_cyclix_genvar = ~act_spike_out;
		act_spike_out = gen206_cyclix_genvar;
		end
	gen207_cyclix_genvar = ~full_spike_out;
	gen208_cyclix_genvar = (we_spike_out && gen207_cyclix_genvar);
	wr_en_spike_out = gen208_cyclix_genvar;
	gen209_cyclix_genvar = (wr_en_spike_out == 32'd1);
	gen210_cyclix_genvar = gen209_cyclix_genvar;
	gen14_rtl_var = gen210_cyclix_genvar;
	if (gen14_rtl_var)
		begin
		mem_spike_out[wptr_spike_out] = wr_data_spike_out;
		gen211_cyclix_genvar = (credit_spike_out[act_spike_out] + 32'd1);
		credit_spike_out[act_spike_out] = gen211_cyclix_genvar;
		end
	wr_credit_spike_out = credit_spike_out[act_spike_out];
	gen212_cyclix_genvar = ~act_spike_out;
	rd_credit_spike_out = credit_spike_out[gen212_cyclix_genvar];
	...
	gen213_cyclix_genvar = {we_spike_out, rd_spike_out};
	case (gen213_cyclix_genvar)
		32'd1:
			begin
			gen214_cyclix_genvar = ~empty_r_spike_out;
			gen215_cyclix_genvar = gen214_cyclix_genvar;
			gen15_rtl_var = gen215_cyclix_genvar;
			if (gen15_rtl_var)
				begin
				gen216_cyclix_genvar = (rptr_spike_out + 32'd1);
				rptr_n_spike_out = gen216_cyclix_genvar;
				full_n_spike_out = 32'd0;
				gen217_cyclix_genvar = ~act_spike_out;
				gen218_cyclix_genvar = (rd_credit_spike_out > 32'd0);
				gen219_cyclix_genvar = gen218_cyclix_genvar;
				gen16_rtl_var = gen219_cyclix_genvar;
				if (gen16_rtl_var)
					begin
					gen220_cyclix_genvar = (credit_spike_out[gen217_cyclix_genvar] - 32'd1);
					credit_spike_out[gen217_cyclix_genvar] = gen220_cyclix_genvar;
					end
				gen221_cyclix_genvar = 1'd0;
				gen221_cyclix_genvar = (gen221_cyclix_genvar || gen219_cyclix_genvar);
				gen221_cyclix_genvar = !gen221_cyclix_genvar;
				gen17_rtl_var = gen221_cyclix_genvar;
				if (gen17_rtl_var)
					begin
					credit_spike_out[gen217_cyclix_genvar] = 32'd0;
					end
				gen222_cyclix_genvar = (rptr_spike_out + 32'd1);
				gen223_cyclix_genvar = (gen222_cyclix_genvar == wptr_spike_out);
				gen224_cyclix_genvar = gen223_cyclix_genvar;
				gen18_rtl_var = gen224_cyclix_genvar;
				if (gen18_rtl_var)
					begin
					empty_n_spike_out = 32'd1;
					end
				end
			gen225_cyclix_genvar = 1'd0;
			gen225_cyclix_genvar = (gen225_cyclix_genvar || gen215_cyclix_genvar);
			gen225_cyclix_genvar = !gen225_cyclix_genvar;
			gen19_rtl_var = gen225_cyclix_genvar;
			if (gen19_rtl_var)
				begin
				gen226_cyclix_genvar = ~act_spike_out;
				credit_spike_out[gen226_cyclix_genvar] = 32'd0;
				end
			end
		32'd2:
			begin
			...
			gen20_rtl_var = gen228_cyclix_genvar;
			if (gen20_rtl_var)
				begin
				gen229_cyclix_genvar = (wptr_spike_out + 32'd1);
				wptr_n_spike_out = gen229_cyclix_genvar;
				empty_n_spike_out = 32'd0;
				gen230_cyclix_genvar = (wptr_spike_out + 32'd1);
				gen231_cyclix_genvar = (gen230_cyclix_genvar == rptr_spike_out);
				gen232_cyclix_genvar = gen231_cyclix_genvar;
				gen21_rtl_var = gen232_cyclix_genvar;
				if (gen21_rtl_var)
					begin
		...
		32'd3:
			begin
			gen233_cyclix_genvar = (wptr_spike_out + 32'd1);
			wptr_n_spike_out = gen233_cyclix_genvar;
			gen234_cyclix_genvar = (rptr_spike_out + 32'd1);
			rptr_n_spike_out = gen234_cyclix_genvar;
			gen235_cyclix_genvar = ~act_spike_out;
			gen236_cyclix_genvar = (rd_credit_spike_out > 32'd0);
			gen237_cyclix_genvar = gen236_cyclix_genvar;
			gen22_rtl_var = gen237_cyclix_genvar;
			if (gen22_rtl_var)
				begin
				gen238_cyclix_genvar = (credit_spike_out[gen235_cyclix_genvar] - 32'd1);
				credit_spike_out[gen235_cyclix_genvar] = gen238_cyclix_genvar;
				end
			...
			gen23_rtl_var = gen239_cyclix_genvar;
			if (gen23_rtl_var)
				begin
				credit_spike_out[gen235_cyclix_genvar] = 32'd0;
				end
			end
	endcase
	rd_data_Vmemb = mem_Vmemb[rd_idx_Vmemb];
	gen240_cyclix_genvar = (we_Vmemb == 32'd1);
	gen241_cyclix_genvar = gen240_cyclix_genvar;
	gen24_rtl_var = gen241_cyclix_genvar;
	if (gen24_rtl_var)
		begin
	...
	done_sel0 = 32'd0;
	en_w_l1_r = 32'd0;
	gen242_cyclix_genvar = (step_en_sel0 && busy_sel0);
	gen243_cyclix_genvar = (state_sel0 == 32'd0);
	gen244_cyclix_genvar = gen243_cyclix_genvar;
	gen25_rtl_var = gen244_cyclix_genvar;
	if (gen25_rtl_var)
		begin
		busy_sel0 = 32'd0;
		gen245_cyclix_genvar = (start_sel0 == 32'd1);
		gen246_cyclix_genvar = gen245_cyclix_genvar;
		gen26_rtl_var = gen246_cyclix_genvar;
		if (gen26_rtl_var)
			begin
	...
	gen247_cyclix_genvar = (state_sel0 == 32'd1);
	gen248_cyclix_genvar = gen247_cyclix_genvar;
	gen27_rtl_var = gen248_cyclix_genvar;
	if (gen27_rtl_var)
		begin
		busy_sel0 = 32'd1;
		gen249_cyclix_genvar = (prelatched_sel0 * cfg_postsynCount_r);
		gen250_cyclix_genvar = (gen249_cyclix_genvar + postidx_sel0);
		gen251_cyclix_genvar = (gen250_cyclix_genvar + cfg_baseAddr_r);
		adr_w_l1_r = gen251_cyclix_genvar;
		en_w_l1_r = 32'd1;
		gen252_cyclix_genvar = (gen242_cyclix_genvar == 32'd1);
		gen253_cyclix_genvar = gen252_cyclix_genvar;
		gen28_rtl_var = gen253_cyclix_genvar;
		if (gen28_rtl_var)
			begin
			gen254_cyclix_genvar = (cfg_postsynCount_r - 32'd1);
			gen255_cyclix_genvar = (postidx_sel0 == gen254_cyclix_genvar);
			gen256_cyclix_genvar = gen255_cyclix_genvar;
			gen29_rtl_var = gen256_cyclix_genvar;
			if (gen29_rtl_var)
				begin
				done_sel0 = 32'd1;
				busy_sel0 = 32'd0;
			...
			gen257_cyclix_genvar = (gen257_cyclix_genvar || gen256_cyclix_genvar);
			gen257_cyclix_genvar = !gen257_cyclix_genvar;
			gen30_rtl_var = gen257_cyclix_genvar;
			if (gen30_rtl_var)
				begin
				gen258_cyclix_genvar = (postidx_sel0 + 32'd1);
				postidx_sel0 = gen258_cyclix_genvar;
				end
			end
		end
	syn_st = syn_stn;
	...
	rd_spike_in = 32'd0;
	start_sel0 = 32'd0;
	gen259_cyclix_genvar = (syn_st == 32'd0);
	gen260_cyclix_genvar = gen259_cyclix_genvar;
	gen31_rtl_var = gen260_cyclix_genvar;
	if (gen31_rtl_var)
		begin
		syn_busy = 32'd0;
		gen261_cyclix_genvar = (empty_spike_in == 32'd0);
		gen262_cyclix_genvar = gen261_cyclix_genvar;
		gen32_rtl_var = gen262_cyclix_genvar;
		if (gen32_rtl_var)
			begin
			rd_spike_in = 32'd1;
			syn_stn = 32'd1;
			end
		gen263_cyclix_genvar = 1'd0;
		gen263_cyclix_genvar = (gen263_cyclix_genvar || gen262_cyclix_genvar);
		gen263_cyclix_genvar = !gen263_cyclix_genvar;
		gen33_rtl_var = gen263_cyclix_genvar;
		if (gen33_rtl_var)
			begin
			syn_done = 32'd1;
			end
		end
	gen264_cyclix_genvar = (syn_st == 32'd1);
	gen265_cyclix_genvar = gen264_cyclix_genvar;
	gen34_rtl_var = gen265_cyclix_genvar;
	if (gen34_rtl_var)
		begin
		syn_busy = 32'd1;
		rd_spike_in = 32'd0;
	...
	gen266_cyclix_genvar = (syn_st == 32'd2);
	gen267_cyclix_genvar = gen266_cyclix_genvar;
	gen35_rtl_var = gen267_cyclix_genvar;
	if (gen35_rtl_var)
		begin
		syn_busy = 32'd1;
		start_sel0 = 32'd0;
	...
	gen268_cyclix_genvar = (syn_st == 32'd3);
	gen269_cyclix_genvar = gen268_cyclix_genvar;
	gen36_rtl_var = gen269_cyclix_genvar;
	if (gen36_rtl_var)
		begin
		syn_busy = 32'd1;
		rd_idx_Vmemb = postidx_sel0;
		gen270_cyclix_genvar = (rd_data_Vmemb + dat_w_l1_r);
		wr_idx_Vmemb = postidx_sel0;
		wr_data_Vmemb = gen270_cyclix_genvar;
		we_Vmemb = 32'd1;
		gen271_cyclix_genvar = (done_sel0 == 32'd1);
		gen272_cyclix_genvar = gen271_cyclix_genvar;
		gen37_rtl_var = gen272_cyclix_genvar;
		if (gen37_rtl_var)
			begin
			we_Vmemb = 32'd0;
			syn_stn = 32'd0;
	...
	neur_done = 32'd0;
	we_Vmemb = 32'd0;
	gen273_cyclix_genvar = (neur_st == 32'd0);
	gen274_cyclix_genvar = gen273_cyclix_genvar;
	gen38_rtl_var = gen274_cyclix_genvar;
	if (gen38_rtl_var)
		begin
		neur_busy = 32'd0;
		gen275_cyclix_genvar = (neur_start == 32'd1);
		gen276_cyclix_genvar = gen275_cyclix_genvar;
		gen39_rtl_var = gen276_cyclix_genvar;
		if (gen39_rtl_var)
			begin
			neur_idx = 32'd0;
			neur_busy = 32'd1;
	...
	gen277_cyclix_genvar = (neur_st == 32'd1);
	gen278_cyclix_genvar = gen277_cyclix_genvar;
	gen40_rtl_var = gen278_cyclix_genvar;
	if (gen40_rtl_var)
		begin
		neur_busy = 32'd1;
	...
	gen279_cyclix_genvar = (neur_st == 32'd2);
	gen280_cyclix_genvar = gen279_cyclix_genvar;
	gen41_rtl_var = gen280_cyclix_genvar;
	if (gen41_rtl_var)
		begin
		neur_busy = 32'd1;
		neur_acc = rd_data_Vmemb;
		gen281_cyclix_genvar = (neur_acc - cfg_leakage_r);
		neur_acc = gen281_cyclix_genvar;
		gen282_cyclix_genvar = (neur_acc >> cfg_threshold_r);
		neur_acc = gen282_cyclix_genvar;
		wr_idx_Vmemb = neur_idx;
		wr_data_Vmemb = neur_acc;
		we_Vmemb = 32'd1;
		gen283_cyclix_genvar = (cfg_postsynCount_r - 32'd1);
		gen284_cyclix_genvar = (neur_idx == gen283_cyclix_genvar);
		gen285_cyclix_genvar = gen284_cyclix_genvar;
		gen42_rtl_var = gen285_cyclix_genvar;
		if (gen42_rtl_var)
			begin
			we_Vmemb = 32'd0;
			neur_done = 32'd1;
		...
		gen43_rtl_var = gen286_cyclix_genvar;
		if (gen43_rtl_var)
			begin
			we_Vmemb = 32'd0;
			gen287_cyclix_genvar = (neur_idx + 32'd1);
			neur_idx = gen287_cyclix_genvar;
			neur_stn = 32'd1;
			end
		end
	gen288_cyclix_genvar = (syn_done == 32'd1);
	gen289_cyclix_genvar = gen288_cyclix_genvar;
	gen44_rtl_var = gen289_cyclix_genvar;
	if (gen44_rtl_var)
		begin
		neur_kick = 32'd1;
		end
	gen290_cyclix_genvar = 1'd0;
	gen290_cyclix_genvar = (gen290_cyclix_genvar || gen289_cyclix_genvar);
	gen290_cyclix_genvar = !gen290_cyclix_genvar;
	gen45_rtl_var = gen290_cyclix_genvar;
	if (gen45_rtl_var)
		begin
		neur_kick = 32'd0;
		end
	neur_start = neur_kick;
	emit_st = emit_stn;
	emit_done = 32'd0;
	emit_fired = 32'd0;
	we_spike_out = 32'd0;
	we_Vmemb = 32'd0;
	gen291_cyclix_genvar = (emit_st == 32'd0);
	gen292_cyclix_genvar = gen291_cyclix_genvar;
	gen46_rtl_var = gen292_cyclix_genvar;
	if (gen46_rtl_var)
		begin
		emit_busy = 32'd0;
		gen293_cyclix_genvar = (emit_start == 32'd1);
		gen294_cyclix_genvar = gen293_cyclix_genvar;
		gen47_rtl_var = gen294_cyclix_genvar;
		if (gen47_rtl_var)
			begin
			emit_idx = 32'd0;
			emit_busy = 32'd1;
	...
	gen295_cyclix_genvar = (emit_st == 32'd1);
	gen296_cyclix_genvar = gen295_cyclix_genvar;
	gen48_rtl_var = gen296_cyclix_genvar;
	if (gen48_rtl_var)
		begin
		emit_busy = 32'd1;
	...
	gen297_cyclix_genvar = (emit_st == 32'd2);
	gen298_cyclix_genvar = gen297_cyclix_genvar;
	gen49_rtl_var = gen298_cyclix_genvar;
	if (gen49_rtl_var)
		begin
		emit_busy = 32'd1;
		gen299_cyclix_genvar = (rd_data_Vmemb > cfg_threshold_r);
		gen300_cyclix_genvar = (rd_data_Vmemb == cfg_threshold_r);
		gen301_cyclix_genvar = (gen299_cyclix_genvar >= gen300_cyclix_genvar);
		gen302_cyclix_genvar = ~full_spike_out;
		gen303_cyclix_genvar = (gen301_cyclix_genvar && gen302_cyclix_genvar);
		gen304_cyclix_genvar = (gen303_cyclix_genvar == 32'd1);
		gen305_cyclix_genvar = gen304_cyclix_genvar;
		gen50_rtl_var = gen305_cyclix_genvar;
		if (gen50_rtl_var)
			begin
			we_spike_out = 32'd1;
		...
		gen306_cyclix_genvar = (gen301_cyclix_genvar && full_spike_out);
		gen307_cyclix_genvar = (gen306_cyclix_genvar == 32'd1);
		gen308_cyclix_genvar = gen307_cyclix_genvar;
		gen51_rtl_var = gen308_cyclix_genvar;
		if (gen51_rtl_var)
			begin
			emit_stn = 32'd2;
			end
		gen309_cyclix_genvar = ~gen306_cyclix_genvar;
		gen310_cyclix_genvar = (gen309_cyclix_genvar == 32'd1);
		gen311_cyclix_genvar = gen310_cyclix_genvar;
		gen52_rtl_var = gen311_cyclix_genvar;
		if (gen52_rtl_var)
			begin
			gen312_cyclix_genvar = (cfg_postsynCount_r - 32'd1);
			gen313_cyclix_genvar = (emit_idx == gen312_cyclix_genvar);
			gen314_cyclix_genvar = gen313_cyclix_genvar;
			gen53_rtl_var = gen314_cyclix_genvar;
			if (gen53_rtl_var)
				begin
				emit_done = 32'd1;
				emit_busy = 32'd0;
			...
			gen315_cyclix_genvar = 1'd0;
			gen315_cyclix_genvar = (gen315_cyclix_genvar || gen314_cyclix_genvar);
			gen315_cyclix_genvar = !gen315_cyclix_genvar;
			gen54_rtl_var = gen315_cyclix_genvar;
			if (gen54_rtl_var)
				begin
				gen316_cyclix_genvar = (emit_idx + 32'd1);
				emit_idx = gen316_cyclix_genvar;
				emit_stn = 32'd1;
				end
			end
		end
	gen317_cyclix_genvar = (neur_done == 32'd1);
	gen318_cyclix_genvar = gen317_cyclix_genvar;
	gen55_rtl_var = gen318_cyclix_genvar;
	if (gen55_rtl_var)
		begin
		emit_kick = 32'd1;
		end
	gen319_cyclix_genvar = 1'd0;
	gen319_cyclix_genvar = (gen319_cyclix_genvar || gen318_cyclix_genvar);
	gen319_cyclix_genvar = !gen319_cyclix_genvar;
	gen56_rtl_var = gen319_cyclix_genvar;
	if (gen56_rtl_var)
		begin
		emit_kick = 32'd0;
		end
	emit_start = emit_kick;
	end
